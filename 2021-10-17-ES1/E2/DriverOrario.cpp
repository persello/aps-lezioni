...
int main() {
  ...
  // Stampa l'orario
  cout << orario1.Ore() << ":" << orario1.Minuti() << ":" << orario1.Secondi() << endl;
  ...
  // Stampa l'orario
  cout << orario2.Ore() << ":" << orario2.Minuti() << ":" << orario2.Secondi() << endl;
  ...
  // Stampa l'orario
  cout << orario3.Ore() << ":" << orario3.Minuti() << ":" << orario3.Secondi() << endl;
